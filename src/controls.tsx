...
const showLegendButtonsControl: ControlSetItem = {
  name: 'show_legend_buttons',
  config: {
    type: 'CheckboxControl',
    label: t('Show legend Buttons'),
    renderTrigger: true,
    default: showLegendButtons,
    description: t('Whether to display a legend buttons for the chart'),
