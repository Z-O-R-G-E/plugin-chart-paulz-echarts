...
type getLegendPropsType = {
  showLegendButtons: boolean;
...
export function getLegendProps(
  ...
  zoomable = false,
  legendState?: LegendState,
): getLegendPropsType | getLegendPropsType[] {
  const legend: getLegendPropsType | getLegendPropsType[] = {
